...
connect Xtron Pro to iot server.

```sig
xtroniot.mqttConnect("")
```
...
Download Xconsole APP from Appstore or Google play. open app and click the logo `XTRON`.
...
Connect to wifi and connect to IoT server
