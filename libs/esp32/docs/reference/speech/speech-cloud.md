...
Xtron Pro use speech cloud services.Currently supports Baidu and Google.

```sig
speech.setSrCloud(SrCloud.Google)
```

After setting up the speech cloud, you can perform speech recognition and text to speech.

## Parameters

* **cloud**: the speech cloud service.
