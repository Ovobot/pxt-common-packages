...
When Xtron Pro is awakened, this method will be called.
...
Connect to wifi and set speech cloud service, set wake word `Jeson`. Say `Hi Jeson` and see what happens.
