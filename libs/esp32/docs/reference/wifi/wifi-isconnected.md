...
Determine if Xtron Pro is connected to Wi-Fi.
...
* a [boolean](/types/boolean): `true` if the wifi is connected, `false` if the wifi is not connected
...
[wifi connect](/reference/wifi/wifi-connect),
